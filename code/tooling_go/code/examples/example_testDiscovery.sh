...
echo '    <testcase classname="test.test_simple" name="test_simple" qualifiedName="test/test_simple.py::test_simple"/>'
echo '    <testcase classname="test.test_simple" name="test_simple_two" qualifiedName="test/test_simple.py::test_simple_two"/>'
echo '</testsuite>'
